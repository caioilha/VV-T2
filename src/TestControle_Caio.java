...
public class TestControle_Caio {
	...
	public void testSequence1(){
		...
		try {
			c.open(1); //é pra dar erro, então gambiarra
			assertEquals(1,0);
		}
		catch (Exception e){
			assertEquals(1,1);		
	...
	//teste 4 Test Sequence 4 (208) :	[setH(2), setH(1), open(2), resetH(2), open(1)]
	@Test
	...
	//teste 5 Test Sequence 5 (209) :	[setH(2), setH(1), open(2), resetH(2), setH(1)]
	@Test
	...
	//teste 6 Test Sequence 6 (193) :	[setH(2), setH(1), open(2), resetH(1), open(1)]
	@Test
	...
	//teste 7 Test Sequence 7 (194) :	[setH(2), setH(1), open(2), resetH(1), setH(1)]
	@Test
	...
	//teste 8 Test Sequence 8 (195) :	[setH(2), setH(1), open(2), resetH(1), open(2)]
